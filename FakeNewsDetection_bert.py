# -*- coding: utf-8 -*-
"""1-fakenewsdetection-bert.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/github/swapnilbetkar/python/blob/main/1_fakenewsdetection_bert.ipynb
...
# true_data = pd.read_csv(os.path.join('/content/fake_news_detection','True.csv'))
# fake_data = pd.read_csv(os.path.join('/content/fake_news_detection','Fake.csv'))
...
data = true_data.append(fake_data).sample(
...
"""## Step 1 : analyze title of document to analyze whether its fake or not

## 1.1 BERT Fine Tuning

### Train Test Validation split using *Stratified  split* 70:30 : 
"""
...
plt.title('Histogram for words and Text distribution')
